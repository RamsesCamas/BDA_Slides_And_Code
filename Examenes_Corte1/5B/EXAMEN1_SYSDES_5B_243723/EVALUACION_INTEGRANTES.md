...
```
===============================================================
EVALUACION: EXAMEN1_SYSDES_5B_243723 / 243723, 243706, 243737
...
> **NOTA:** Esta entrega es identica a la encontrada en la carpeta EXAMEN1_SYSDES_5B_243706. Se trata del mismo equipo de 3 integrantes que entrego en multiples carpetas. La evaluacion aplica por igual a los tres integrantes.
...
- La Vista 2 tiene un error menor de sintaxis: falta un espacio antes de `ELSE` en la linea `'EstandardELSE 'Baja Actividad'` (dice `'EstandardELSE` en vez de `'Estandar' ELSE`).
